...
if __name__ == '__main__':
    ...
    raw_text = '一、重要提示：1、经中国银行间市场交易商协会中市协注[2022] DFI 12号文@@件批准，三一集团有限公' \
               ...
               '商购买本期债务融资工具。@@'
    raw_text_1 = '二、本期债务融资工具主要条款：1、债务融资工具全称：三一集团有限公司2022年度第十四期@@超短期融资券（科创票据）@@2、' \
    ...
    # torch_space()
    # print(type([i for i in raw_text]) == type([1, 2]))
    raw_texts = [raw_text]
    raw_texts.append(raw_text_1)
    labels = server_test(json.dumps(raw_texts, ensure_ascii=False), "http://10.17.107.66:8092/prediction_batch/")
    # labels = server_test(raw_text, "http://10.17.107.66:8092/prediction/")
    print(labels)
    # print('labels', labels)
