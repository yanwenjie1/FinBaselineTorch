...
from transformers import BertModel, AutoModel, AlbertModel, RoFormerModel, AutoModelForSequenceClassification, AutoModelForMaskedLM
...
class BaseModel(nn.Module):
    ...
    def __init__(self, bert_dir, dropout_prob, model_name=None):
        ...
        if 'electra' in model_name:
            ...
            # self.bert_module = AutoModelForSequenceClassification.from_pretrained(bert_dir,
            #                                                                       output_hidden_states=False,
            #                                                                       hidden_dropout_prob=dropout_prob)
            self.bert_module = AutoModel.from_pretrained(bert_dir,
                                                         output_hidden_states=False,
